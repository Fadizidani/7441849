...
message.channel.send(
  ...
  .setColor("#9B59B6")
  .addField(" ** :gear: Server Support :gear: **" , "  **مافي سرفر دعم**")
...
client.users.get("516473846983950336").sends
    "\n" + "**" + args + "**")
...
message.channel.send(`? | سيتم ارسال الرسالة الى ${message.guild.members.size} عضو`).then(m => m.delete(5000));
